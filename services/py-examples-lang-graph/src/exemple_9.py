...
db = postgres_connection.get_sql_database()
...
#     print("POSTGRES_HOST_TEST =", POSTGRES_HOST_TEST)
#     print("POSTGRES_PORT_TEST =", POSTGRES_PORT_TEST)
#     print("POSTGRES_USER_TEST =", POSTGRES_USER_TEST)
#     print("POSTGRES_DB_TEST =", POSTGRES_DB_TEST)
#     print("Connection string =", connection_string)
#     print(f"Dialect: {db.dialect}")
#     print(f"Available tables: {db.get_usable_table_names()}")
#     print(f'Sample output: {db.run("SELECT * FROM test_orders LIMIT 5;")}')
